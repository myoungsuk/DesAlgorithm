...
public class Des {
    ...
    private static long[] createSubkeys(/* 64 bits */ long key) {
        ...
        System.out.println(" PC1 c : " + c);
        System.out.println(" PC1 c : " + d);
        ...
        for (int i = 0; i < 16; i++) {
            ...
            String binarycd = Long.toBinaryString(cd);
            System.out.println(" binarycd : " + binarycd );
            // perform the PC2 permutation
            subkeys[i] = PC2(cd);
            // String keyhex[] = Integer.toHexString(subkeys[0]);

            String keyhex = Long.toHexString(subkeys[i]);
            System.out.printf(" real keyhex %d  : %s \n" ,  i , keyhex);
...
//            System.out.println(" l hex : " + lhex);
//
//            String rhex = Integer.toHexString(r);
//            System.out.println(" r hex : " + rhex);
        }
